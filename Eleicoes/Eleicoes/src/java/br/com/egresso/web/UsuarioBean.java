...
public class UsuarioBean {
    ...
    public String salvar() {
        ...
        String senha = this.usuario.getMatricula();
    ...
    public String logar() {
        ...
        if (login == null || login.equals("") && (password == null || password.equals(""))) {
            MensagemContexto.adicionarMensagem("Nome e matricula não podem ser vazios!");
        } else {
            if (login == null || login.equals("")) {
                MensagemContexto.adicionarMensagem("Nome não pode ser vazio!");
            } else {
                if (password == null || password.equals("")) {
                    MensagemContexto.adicionarMensagem("Matricula não pode ser vazio!");
                } else {
                    UsuarioRN usuarioRN = new UsuarioRN();
                    usuario = new Usuario();
                    ...
                    if (usuario != null && (usuario.getMatricula().equals(password))) {
                        setLogado(true);
                        return "/restrito/principal";
                    } else {
                        setLogado(false);
                        MensagemContexto.adicionarMensagem("Nome ou Matricula inválidos");
                    }
                }
            }
        }
