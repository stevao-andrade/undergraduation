...
public class Questionario implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.listaDeRespostas != other.listaDeRespostas && (this.listaDeRespostas == null || !this.listaDeRespostas.equals(other.listaDeRespostas))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 11 * hash + this.codigo_questionario;
        hash = 11 * hash + (this.nomeQuestionario != null ? this.nomeQuestionario.hashCode() : 0);
        hash = 11 * hash + (this.dataCriacao != null ? this.dataCriacao.hashCode() : 0);
        hash = 11 * hash + (this.dataDisponibilidadeFinal != null ? this.dataDisponibilidadeFinal.hashCode() : 0);
        hash = 11 * hash + (this.curso != null ? this.curso.hashCode() : 0);
        hash = 11 * hash + (this.questoes != null ? this.questoes.hashCode() : 0);
        hash = 11 * hash + (this.listaDeRespostas != null ? this.listaDeRespostas.hashCode() : 0);
        return hash;
    }
}