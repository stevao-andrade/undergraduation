...
public class Gps implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 73 * hash + (this.numeroSerie != null ? this.numeroSerie.hashCode() : 0);
        hash = 73 * hash + (this.numeroAutorizado != null ? this.numeroAutorizado.hashCode() : 0);
        hash = 73 * hash + (this.data != null ? this.data.hashCode() : 0);
        hash = 73 * hash + (this.latitude != null ? this.latitude.hashCode() : 0);
        hash = 73 * hash + (this.longitude != null ? this.longitude.hashCode() : 0);
        hash = 73 * hash + (this.altitude != null ? this.altitude.hashCode() : 0);
        hash = 73 * hash + (this.velocidade != null ? this.velocidade.hashCode() : 0);
        hash = 73 * hash + (this.imei != null ? this.imei.hashCode() : 0);
        return hash;
    }
