...
CREATE  TABLE IF NOT EXISTS `forcajr`.`alterados` (
  ...
  `blocoSocio` VARCHAR(200) NOT NULL ,
...
INSERT INTO `forcajr`.`alterados` (`idSocioPK`, `idSocio`, `nomeSocio`, `cpfSocio`, `rgSocio`, `matSocio`, `sexoSocio`, `diaNascSocio`, `mesNascSocio`, `anoNascSocio`, `enderecoSocio`, `numEndSocio`, `bairroSocio`, `cidadeSocio`, `foneSocio`, `celSocio`, `emailSocio`, `estadoSocio`, `blocoSocio`, `funcaoSocio`, `data`) VALUES (10000000, 00, 'moc', '000.000.000-00', 0000000, '00000000', 'masculino', 00, '00', 0000, '000000', '000', '00000000', '00000000000', '00000000000', '0000000000', '00000000000', '000000000000', '00', '0000000000000', '00000000');
...
INSERT INTO `forcajr`.`usuario` (`id`, `nomeUsuario`, `senhaUsuario`) VALUES (01, 'fjinformatica', 'master');